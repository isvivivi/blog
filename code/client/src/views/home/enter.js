...
function blackhole(element) {
	...
	function loop(){
		...
		context.fillStyle = '#110E19'; // somewhat clear the context, this way there will be trails behind the stars 
	...
	function init(time){
		context.fillStyle = '#110E19';  // Initial clear of the canvas, to avoid an issue where it all gets too dark
		context.fillRect(0, 0, cw, ch);
